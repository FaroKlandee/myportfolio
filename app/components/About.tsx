            ...
            <div className="container-custom">
                ...
                >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        <a href="https://www.figma.com/" target="_blank" rel="noopener noreferrer nofollow" className="card flex items-center p-4 hover:border-white/30 transition-colors">
                        ...
                        <a href="https://nextjs.org/" target="_blank" rel="noopener noreferrer nofollow" className="card flex items-center p-4 hover:border-white/30 transition-colors">
                        ...
                        <a href="https://tailwindcss.com/" target="_blank" rel="noopener noreferrer nofollow" className="card flex items-center p-4 hover:border-white/30 transition-colors">
                            <svg className="text-4xl mr-4 w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <a href="https://stripe.com/" target="_blank" rel="noopener noreferrer nofollow" className="card flex items-center p-4 hover:border-white/30 transition-colors">
                            <svg className="text-4xl mr-4 w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
